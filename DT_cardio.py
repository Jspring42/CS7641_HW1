...
def main():
    ...
    plt.title("Cardio DT Validation Curve (max_depth)")
    ...
    plt.fill_between(param_range, test_scores_mean - test_scores_std,
                     ...
                     color="navy", lw=lw)
    plt.legend(loc="best")
    fig.savefig('DT_cardio_depth.png')
    
    
    # alpha tuning
    param_range = np.arange(0.0001, 0.04, 0.0005)
    ...
    plt.title("Cardio DT Validation Curve (alpha)")
    plt.xlabel("alpha")
    plt.ylabel("Accuracy")
    ...
    plt.fill_between(param_range, test_scores_mean - test_scores_std,
                     ...
                     color="navy", lw=lw)
    plt.legend(loc="best")
    fig.savefig('DT_cardio_alpha.png')
    
    # learning curve
    final_model = DecisionTreeClassifier(random_state=42, max_depth=30,ccp_alpha=0.0001)
    ...
    axes[0].set_title("Cardio DT Learning Curve/Size")
    ...
    axes[1].set_title("Cardio DT Learning Curve/Iteration Time")
    fig.savefig('DT_cardio_lc.png')
    ...
    plt.title ("Cardio DT Confusion Matrix", fontdict = {'size':18}, pad = 20)
    plt.savefig('DT_cardio_holdout_pred.png')